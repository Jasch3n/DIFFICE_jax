...
def dataf(k):
    return [X_star, U_star, X_ct, nnct, [scale], boundary_star]
...
try:
    ...
    print("Running Adam")
    from diffice_jax.optimizer.optimization import adam_opt
    trained_params, loss_adam = adam_opt(
        key, NN_loss, trained_params, dataf, 2, 
        lr=1e-3, adaptive=False)
    print("Adam successful")
